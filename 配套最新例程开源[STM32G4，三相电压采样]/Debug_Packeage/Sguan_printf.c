 ...
 * @Date: 2026-08-09 01:17:15
 * @LastEditors: 星必尘Sguan|3464647102@qq.com
 * @LastEditTime: 2026-08-10 15:54:29
 * @FilePath: \SguanESC_Debug\Debug_Packeage\Sguan_printf.c
 * @Description: SguanESC库的“串口调试printf函数实现”
 * 
...
static void Handle_Ubus(float value);
...
// 指令处理回调函数库->Uq
static void Handle_Ubus(float value){
    Sguan.Func_Set_Ubus(value);
}


// 动态可修改的指令字典（预留 hash_val 位置为 0）
__CMD_MAP_STRUCT Cmd_Dict[] = {
...
#define DICT_COUNT (sizeof(Cmd_Dict) / sizeof(__CMD_MAP_STRUCT))
